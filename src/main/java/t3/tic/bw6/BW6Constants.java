...
public class BW6Constants {
	...
	public static String capabilityPattern = "(.*); filter:=\"(.*)\"";
	public static String capabilityFilterPattern = "\\(&\\(name=(.*)\\)\\(version=(.*)\\)\\)";
	public static String providedCapabilityPattern = "com\\.tibco\\.bw\\.module; name=\"(.*)\"; version:Version=\"(.*)\"";
}
